...
# rake install                                # Build and install ast-merge-1.0.0.gem in...
# rake install:local                          # Build and install ast-merge-1.0.0.gem in...
# rake kettle:jem:install                     # Install ast-merge GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template ast-merge against itse...
# rake kettle:jem:template                    # Template ast-merge files into the curren...
