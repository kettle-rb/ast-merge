  ...
  module Merge
    module Testing
      ...
      class TestableNode < TreeHaver::Node
        ...
        # Check if this is our testable node
        def testable?
          true
        end
      end
...
# Make it available at top level for convenience in specs
TestableNode = Ast::Merge::Testing::TestableNode
