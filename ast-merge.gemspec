...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/ast/merge/version.rb", mod) }::Ast::Merge::Version::VERSION
  else
    ...
    require "ast/merge/version"
    Ast::Merge::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  # The 'git' gem is optional; ast-merge falls back to shelling out to `git` if it is not present.
